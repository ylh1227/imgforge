...
pub trait ReviewRepository {
  ...
  fn add_annotation(&self, image_item_id: i64, annotation: &Annotation) -> Result<i64, ReviewError>;
  ...
  fn batch_update_status(&self, item_ids: &[i64], status: ReviewStatus) -> Result<usize, ReviewError>;
